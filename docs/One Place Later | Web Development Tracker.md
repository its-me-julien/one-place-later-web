...
| 2026-08-17 | Creative Field Guide | Established the reusable chapter pattern across sections 1–23: numbered orientation, concise thesis, structured comparisons, routes, templates, step sequences, or decision prompts, and one working takeaway, with responsive anchor positioning. Sections 15–23 add the movement test, perspective map, camera-role split, technical-safety boundaries, sound and music rules, bridge transitions, a text system, and the restrained arrow/colour syntax. | Release record |
